...
-- 3. ? 
SELECT STUDENT_NAME 학생이름, STUDENT_NO 학번, TO_CHAR(STUDENT_ADDRESS) "거주지 주소"
FROM TB_STUDENT
...
WHERE CATEGORY = '인문사회'
ORDER BY C.DEPARTMENT_NO, 2 ASC;
-- 10.
...
FROM TB_STUDENT(SELECT STUDENT_NO, STUDENT_NAME, AVG(POINT) AS POINT
                FROM TB_STUDENT
